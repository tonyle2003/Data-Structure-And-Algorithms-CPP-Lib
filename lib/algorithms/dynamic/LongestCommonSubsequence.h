...
class LongestCommonSubsequence {
    public:
        ...
        static int length(string, string, int, int);
};

int LongestCommonSubsequence::length(string str1, string str2) {
...
int LongestCommonSubsequence::length(string str1, string str2, int size1, int size2) {
    if (size1 == 0 || size2 == 0) {
        return 0;
    }
